...
| `scientific domain`             | Optional                                   | [Tag variable - see guidance](#edit-a-project) <br/> _Examples:_ Animal behavior, Bioimaging, Deep learning, Electrophysiology, Machine learning, Neuroscience, Spatial transcriptomics                                                                                                                                                                                                                                            |
| `model organism`                | Optional                                   | [Tag variable - see guidance](#edit-a-project) <br/> _Examples:_ C. Elegans, Fly, Mouse                                                                                                                                                                                                                                                                                                                                            |
...
| `programming language`          | Optional                                   | [Tag variable - see guidance](#edit-a-project) <br/> _Examples:_ C++, Java, Julia, Kotlin, MATLAB, Nextflow, Python                                                                                                                                                                                                                                                                                                                |
...
| `related laboratory techniques` | Optional                                   | [Tag variable - see guidance](#edit-a-project) <br/> _Examples:_ Calcium imaging, Confocal light microscopy (LM), Correlative light EM (CLEM), EASI-FISH, Electron microscopy (EM), Expansion microscopy (ExM), FISH, Lightsheet fluorescence microscopy (LFSM), MERFISH, Neural recording, Single-molecule localization microscopy (SMLM), SlideSeq, Two-photon imaging                                                           |
| `software use case`             | Optional                                   | [Tag variable - see guidance](#edit-a-project) <br/> _Examples:_ Annotation, Electrophysiology analysis, Image analysis, Image registration, Sequence analysis, Tool packaging/distribution, Video analysis                                                                                                                                                                                                                        |
