...
| `open source license`             | Optional                                               | [Tag variable - see guidance](#edit-a-project) <br/> _Examples:_ BSD-3 Clause, CC-by-0, GPL-2.0, GPL-3.0, MIT                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
**Case 1 - Request new tag category**

1. _Do not add the new tag category to your project's template._ Open a separate [pull request](#open-a-pull-request) listing the new tag category(ies) and the corresponding tag option(s) you wish to add. Make sure to select the "new tags added" label.
