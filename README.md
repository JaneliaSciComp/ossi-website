...
| `video url`                      | Optional                                                           | Link to an externally-hosted video about your software project (e.g., a video uploaded to YouTube).                                                                                                                                                                     |
| `video caption`                  | Required if you add a video link                                   | A brief description of the video - this will be displayed on the site                                                                                                                                                                                                   |
