...
const projectsCollection = defineCollection({
    ...
    schema: ({image}) => z.object({
      ...
      'github repository link array': z.union([z.array(z.string()), z.string()]).optional(),
      'github repository text array': z.union([z.array(z.string()), z.string()]).optional(),
      'project homepage link array': z.union([z.array(z.string()), z.string()]).optional(),
      'project homepage text array': z.union([z.array(z.string()), z.string()]).optional(), 
