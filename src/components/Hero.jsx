  ...
  return (
    ...
    >
      <div className="flex flex-col 2xl:flex-row justify-between md:justify-around 2xl:items-center h-3/4 md:h-5/6 2xl:h-auto 2xl:w-11/12">
        ...
        {children && (
          <div className="bg-blue-50 dark:bg-slate-900 bg-opacity-90 py-12 md:py-6 lg:py-20 w-auto lg:self-start md:mx-12 lg:ml-20 xl:ml-32 2xl:mx-20 md:rounded-2xl">
            {children}
          </div>
        )}
      </div>
